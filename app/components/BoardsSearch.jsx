...
useEffect(()=>{
  ...
  const handleSearch = (event) => {
    ...
    // Use the `push` method with the query parameter to update the URL
    router.push(`/boardsearch?query=${query}`);
  };
    ...
    <div className="container mx-auto py-2">
      <div className="sticky top-[70px] bg-white">
        <form
          ...
          className="flex items-center max-w-[700px] my-3 mx-2 sm:mx-auto md:py-2 bg-black rounded border-none overflow-hidden"
        >
          <input
          ...
          <div className="p-2">
            <button
              className="text-white bg-black px-2 flex items-center focus:outline-none"
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between leading-normal">
              ...
              <p className="text-gray-700 text-lg font-medium">
                {billboard.address.city},{billboard.address.state},
                {billboard.address.country}
              </p>
              <p className="text-gray-900 font-bold">
                {billboard.boardvacanDate}
              </p>
            </div>
              ...
              <div className="grid grid-rows-2 ">
                ...
                <div className=" mt-8">
                  ...
                  <Link href={`/board/${billboard._id}`}>
                    <button
                      type="button"
                      className="m-1 mr-2 p-2 text-sm text-white bg-blue-600 rounded"
                    >
                      More Details
                    </button>
                  </Link>
