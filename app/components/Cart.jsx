      ...
      return (
        <div className="container mx-auto py-2">
          <div className="grid grid-cols-1  max-w-[700px]  mx-auto gap-4">
            <h1 className="text-2xl font-bold mx-2 pb-2 px-1 md:mx-0">Your boards</h1>
              ...
              >
                ...
                <div className="p-4 flex flex-col justify-between leading-normal">
                  ...
                  <div className="text-gray-700 font-medium">
                    ...
                    <button type="button" className='px-2 m-1 mx-2 rounded bg-slate-400'>+</button>{3}
                    <button type="button" className='px-2 m-1 mx-2 rounded bg-slate-400'>-</button>
                  </div>
                  <div className="flex my-1 text-gray-700 font-medium">
                  <label htmlFor="startDate" className='mr-1'> Start Date:</label>
        ...
        <div className="mt-4">
          ...
          <img src={image} alt="Preview" className="max-w-full h-auto" />
                ...
                <div className="grid grid-rows-[80%,20%] " >
                    <div className=""></div>
                    <div className="">
                <button type="button" className="m-1 p-2 text-sm bg-green-600 rounded">Buy</button>
