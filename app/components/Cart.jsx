...
const Cart = () => {
  ...
  const { getUserCart, cart } = useContext(CartContext);
...
const CartBoards = ({ board }) => {
  ...
  const { fetchSingleBoard, billboard } = useContext(CartContext)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col justify-between leading-normal">
        ...
        {board.status === "active" ? (<><div className="p-[4px] border-2 text-gray-700 border-pink-500 rounded-md">Email to request</div></>) :
          (<div>
            <label
              htmlFor="imageUpload"
